...
class FrmTranslator:
    ...
    def aturKomponen(self):
        ...
        # Pasang Button
        self.btnTranslate = Button(mainFrame, text='Translate to indonesia',
            command=lambda: self.onTranslate('id'))
        ...
        self.btnTranslate = Button(mainFrame, text='Translate to spanyol',
            command=lambda: self.onTranslate('is'))
